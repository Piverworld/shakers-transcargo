            ...
            <div className="container relative z-10 px-4 mx-auto">
                <div className="flex flex-col items-center gap-12 lg:flex-row">
                    ...
                    <div className="flex-1">
                        <div className="flex flex-col items-start justify-start gap-2 mb-8 lg:flex-row lg:items-center lg:justify-start">
                            <div className="w-16 h-16 mr-6 rounded-lg bg-brand-yellow">
                                ...
                                >
                                    <g>
                                        <path
                                            d="M264.778,132.188h0.008c0.008,0.008,0.008,0.008,0.008,0.008L264.778,132.188z"
                                            fill="#ffffff"
                                        />
                                        <path
                                            d="M397.04,291.532c9.927-12.098,21.84-31.151,20.335-51.746L315.137,137.549c0,0-18.518-4.589-40.648,0.215
                                        ...
                                        />
                                        <path
                                            d="M138.565,58.974L0,197.53l57.454,57.462l138.571-138.565L138.565,58.974z M69.278,205.981
                                        ...
                                        />
                                        <path
                                            d="M373.436,55.593l-57.461,57.453l138.572,138.564L512,194.157L373.436,55.593z M442.715,202.609
                        ...
                        <p className="max-w-2xl mb-8 text-xl leading-relaxed text-gray-300">
                            WIR SUCHEN ENGAGIERTE FACHKRÄFTE MIT LEIDENSCHAFT FÜR DIE SCHIENE – MENSCHEN,
                            DIE GEMEINSAM MIT UNS DIE ZUKUNFT DER LOGISTIK GESTALTEN WOLLEN.
                        </p>

                        <a href="#jobs" className="inline-flex items-center px-8 py-4 text-lg btn-secondary hover:bg-brand-yellow hover:text-white">
                            JETZT BEWERBEN →
                        </a>
                    </div>

                    {/* Right side - Visual element or spacing */}
                    <div className="justify-end flex-1 lg:flex">
                        <div className="relative flex items-center justify-center w-full max-w-md max-md:w-full">
